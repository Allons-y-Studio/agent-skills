...
* **gh-notification-summary:**add GitHub notification management skill ([#1](https://github.com/castastrophe/agent-skills/issues/1)) ([321d678]())
...
*rebuild the skills platform on Node.js with GitHub-notification and design-system skills ([a9825fa]())
